...
│   └── detect_shapes_digits.py # 几何图形与数字识别
├── images/                       # 测试图像目录
│   ├── basic_preprocessing       # 基础预处理测试结果图
|   |     ├──1.basic_test.jpg
|   |     ├──2_gray.jpg
|   |     ├──3_blur.jpg
|   |     ├──4_equalized.jpg
|   |     ├──preprocessing_comparison.png
|   |     └──均衡化后直方图_histogram.png
│   ├── color_detection            # 颜色识别测试结果图
|   |     ├──images_befor
|   |           ├──lighting_backlit.jpg
|   |           ├──lighting_bright.jpg
|   |           ├──lighting_dark.jpg
|   |           ├──lighting_gradient.jpg
|   |           └──lighting_normal.jpg
|   |     ├──color_detection_result.jpg-later.jpg
|   |     ├──lighting_backlit-later.jpg
|   |     ├──lighting_bright-later.jpg
|   |     ├──lighting_dark-later.jpg
|   |     └──lighting_gradient-later.jpg
│   └── detect_shapes_digits     # 形状数字识别结果测试图
|   |     ├──detect-later.jpg
|   |     └──final_result.png
└── README.md                     # 项目说明文档
```
...
# 运行指定测试
cd src
python main.py -t preprocess -i ../images/basic_preprocessing
python main.py -t color -i ../images/images_before/lighting_backlit.jpg
python main.py -t shape -i ../images/detect-later.jpg
...
# 图像预处理
python basic_preprocessing.py ../images/basic_preprocessing

# 颜色识别
python color_detection.py ../images/images_before/lighting_backlit.jpg

# 形状数字识别
python detect_shapes_digits.py ../images/detect-later.jpg
